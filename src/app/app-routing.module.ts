...
/*  { path: 'archive', loadChildren: './archive/archive.module#ArchivePageModule' },
  ...
  { path: 'diagnostique-intelligent', loadChildren: './diagnostique-intelligent/diagnostique-intelligent.module#DiagnostiqueIntelligentPageModule' },
  ...
  { path: 'compte/boutique', loadChildren: './boutique/boutique.module#BoutiquePageModule' },
  ...
  { path: 'formuler-aliment', loadChildren: './formuler-aliment/formuler-aliment.module#FormulerAlimentPageModule' },
...
//  { path: 'rapport-diagnostique-intelligent', loadChildren: './rapport-diagnostique-intelligent/rapport-diagnostique-intelligent.module#RapportDiagnostiqueIntelligentPageModule' }
];
